...
export function StepCard({ number, title, body, style }: {
  ...
  return (
    <div style={{ borderTop: '2px solid var(--color-steel)', paddingTop: '22px', ...style }}>
      <b style={{ fontWeight: 500, fontSize: '14px', color: 'var(--color-steel-bright)', letterSpacing: '.06em' }}>{number}</b>
